...
export class LeaderboardPanel {
  ...
  public static readonly viewType = 'leaderboard';
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (LeaderboardPanel.currentPanel) {
      ...
      LeaderboardPanel.currentPanel._update();
      return;
    }

    // Otherwise, create a new panel.
    const panel = vscode.window.createWebviewPanel(
      LeaderboardPanel.viewType,
      'Leaderboard',
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, 'out', 'compiled/Leaderboard.js')
    );
